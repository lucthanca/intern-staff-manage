                            ...
                            <div class="card-body px-lg-12 py-lg-12">
                                ...
                                <div class="form-group">
                                    <div class="input-group input-group-alternative mb-3">
                                        ...
                                        <input name="name" class="form-control" placeholder="Nhập tên phòng ban" type="text" value="{{ old('name', $department->name) }}">
                                    </div>
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea rows="4" class="form-control form-control-alternative" placeholder="Nhập mô tả..." name="description">{{ old('description', $department->description) }}</textarea>
                                </div>
